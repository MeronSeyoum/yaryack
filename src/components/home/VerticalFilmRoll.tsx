    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Electrical Wires */}
          <div
            className={`absolute -right-2 top-4 w-4 h-1 ${
              isDarkMode ? "bg-red-500" : "bg-red-600"
            } rounded-r`}
          />
          <div
            className={`absolute -right-2 bottom-4 w-4 h-1 ${
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{
                        ...
                        opacity:
                          distanceFromActive > 1 ? 0 : isActive ? 1 : 0.4,
                      ...
                      >
                        ...
                        <div className="aspect-[3/4] rounded overflow-hidden relative">
                          ...
                          <div
                            ...
                            style={{
                              background:
                                "radial-gradient(ellipse at center, transparent 40%, rgba(0,0,0,0.3) 85%)",
                            }}
                          />
                        </div>
        ...
        >
          ...
          <div className="relative flex justify-center">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(145deg, #10b981 0%, #059669 15%, #047857 35%, #065f46 55%, #064e3b 75%, #022c22 95%)",
                boxShadow: `
              ...
              <div className="absolute inset-2 bg-gradient-to-b from-emerald-100 to-emerald-300 rounded-xl shadow-inner overflow-hidden border border-emerald-200/50">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pt-4 pb-2">
                  ...
                  >
                    200
                    {/* Subtle glow effect */}
                    <div className="absolute inset-0 text-2xl font-black text-white/20 blur-sm">
                      200
                    </div>
                  </motion.div>
